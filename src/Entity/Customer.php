 ...
 * subresourceOperations={"invoices_get_subresource"={"method"="GET","path"="/customers/{id}/invoices"}}
 * )
...
class Customer
{
     ...
     * @Assert\Length(min=3, max=255, minMessage="Le prénom doit faire entre 3 et 255 caractères", maxMessage="Le nom de famille doit faire entre 3 et 255 caractères")
     */
    private $lastName;
     ...
     * @Groups({"customers_read"})
     * @Assert\NotBlank(message="L'utilisatuer est obligatoire")
     */
    private $user;
