...
class Invoice
{
     ...
     * @Assert\Type("numeric", message="Le montant de la facture doit être un numérique !")
     */
    private $amount;
     ...
     * @Assert\Choice(choices={"SENT", "PAID", "CANCELED"}, message="Le statut doit être SENT, PAID, CANCELED")
     */
    private $status;
